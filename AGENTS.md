...
- Keep the app fully browser-based with no application backend.
...
- Keep an explicit demo mode because the TypeSafe API currently rejects arbitrary browser CORS origins.
